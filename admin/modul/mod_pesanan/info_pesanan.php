...
$query = mysqli_query($conn, "SELECT * FROM td_pesanan JOIN tm_user ON td_pesanan.nik = tm_user.nik JOIN tm_kolam ON td_pesanan.id_kolam = tm_kolam.id_kolam WHERE td_pesanan.status = 'Proses Pemesanan' ORDER BY td_pesanan.kd_transaksi DESC") or die(mysqli_error($conn));
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                Manajemen Pesanan Kolam Pemancingan
            </div>
            <hr>
                    ...
                    <table class="table table-striped table-bordered table-hove" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                echo '<td>'; ?>
                                <?php echo '<form action=""><a href=admin.php?halaman=edit_pesanan&&kd_transaksi=' . $data['kd_transaksi'] . '><span style="margin-right: 10px; margin-left:70px;" class="glyphicon glyphicon-edit"></a>' ?>
                                <a href="#" onclick="confirm_modal('../admin/modul/mod_pesanan/delete_pesanan.php?kd_transaksi=<?php echo  $data['kd_transaksi']; ?>');"><span style="margin-left:10px;" class="glyphicon glyphicon-trash"></span></a>
                                <?php echo '</form></td>';
                                echo '</tr>';
                                $no++;
                            }
            ...
            <div class="modal-body">
                ...
                <form action="..\admin\modul\mod_pesanan\add_pesanan.php" class="form-horizontal" method="POST" onsubmit="return validasi_input(this)">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" id="kdtransaksi" name="kd_transaksi" required readonly >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" id="namaLengkap" name="nama_lengkap" disabled='disabled 'required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="jam">
                                ...
                                while ($jm = mysqli_fetch_array($time)) { ?>
                                    <option value="<?php echo $jm['id_jam'] ?>"><?php echo $jm['jam'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="tel" class="form-control" name="total_harga" id="total" placeholder="Harga" readonly required>
                        </div>
                    </div>
                    <div class="form-group">
